...
### Client
- Enhance: 「苦手な絵文字」設定の適用範囲を説明する案内を追加
- Fix: おすすめタイムライン更新後に更新ボタンがすぐ再表示される問題を修正
...
### Server
- Fix: おすすめタイムラインの更新でフォロー中ノートを不適切にスキップする問題を修正
- Fix: おすすめタイムラインの更新時に未表示のフォロー中ノートを既読として扱い、候補が早期に尽きる問題を修正
- Enhance: 共通候補が不足した場合、フォロー中の候補を表示割合を超えて補完するように
- Fix: おすすめタイムライン生成時に二段階フォロー圏を走査してタイムアウトする問題を修正
- Enhance: おすすめタイムラインの表示割合を、二段階フォロー圏からよくリアクションする人へ変更
- Fix: フォロー中のアカウントがいる場合におすすめタイムラインの生成がタイムアウトする問題を修正
- Fix: おすすめタイムラインの再読み込みで未表示候補が失われ、短時間で候補が尽きる問題を修正
- Fix: フォロー数が多いアカウントでおすすめタイムラインの生成が遅くなる問題を修正
- Fix: フォロー関係の変更をおすすめタイムラインへ即時反映するように
- Fix: 個人化候補が少ないアカウントでおすすめタイムライン生成負荷が高くなる問題を修正
- Fix: おすすめタイムラインのスクロール時に個人化候補が早期に減少する問題を修正
- Enhance: おすすめタイムライン生成時の既読取得と個人化候補検索を軽量化
- Fix: おすすめタイムラインで通常ノートを含む既読ノートが再表示される場合がある問題を修正
- Enhance: おすすめタイムラインで、フォロー中・二段階フォロー圏・リアクション傾向の各加点量を設定可能に
- Fix: おすすめタイムラインの候補探索、重複防止、投稿者の分散、非公開化済みノートの除外を改善
- Enhance: おすすめタイムラインの候補が少ない場合の探索を効率化
