...
-->
<template>
<MkModalWindow ref="dialog" :withOkButton="false" :width="500" :height="420" @close="close" @closed="emit('closed')">
...
const translations: Record<string, { title: string; description: string }> = {
	'en-US': { title: 'Memo disliked emojis', description: 'Only you will see this memo. You will be warned before reacting to this account with one of these emojis.' },
	'ja-JP': { title: '苦手な絵文字をメモ', description: 'このメモはあなただけに適用されます。このアカウントに登録した絵文字をつける前に警告を表示します。' },
	'ja-KS': { title: '苦手なツッコミをメモ', description: 'このメモはあんただけに効くで。このアカウントに登録したツッコミをつける前に警告するわ。' },
