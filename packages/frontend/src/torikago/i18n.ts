...
export type TorikagoTranslationKey = keyof typeof translations;

export function torikagoT(key: TorikagoTranslationKey): string {
	const values = translations[key] as Partial<Record<string, string>>;
	return values[lang] ?? values['en-US']!;
}
