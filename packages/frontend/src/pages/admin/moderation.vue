					...
					<MkFolder v-if="enableRecommendedTimeline || collectRecommendedTimelineNotes" style="margin-top: 12px;">
						...
						<div class="_gaps_s">
							...
							<div class="_gaps_s">
								...
								<MkInput v-model.number="recommendedSettings.reducedAccountPenalty" type="number"><template #label>{{ recommendedTimelineAdminText.reducedAccountPenalty }}</template></MkInput>
...
const recommendedSettings = ref({
	...
	reducedAccountPenalty: typeof recommendedRawSettings.reducedAccountPenalty === 'number' ? recommendedRawSettings.reducedAccountPenalty : 12,
...
Object.assign(recommendedTimelineAdminTexts['ja-JP']!, { reducedAccountPenalty: '表示を減らすアカウントの減点量' });
Object.assign(recommendedTimelineAdminTexts['ja-KS']!, { reducedAccountPenalty: '表示を減らすアカウントの減点量' });
Object.assign(recommendedTimelineAdminTexts['ko-KR']!, { reducedAccountPenalty: '표시를 줄인 계정 감점' });
Object.assign(recommendedTimelineAdminTexts['zh-CN']!, { reducedAccountPenalty: '减少显示账号的扣分值' });
Object.assign(recommendedTimelineAdminTexts['zh-TW']!, { reducedAccountPenalty: '減少顯示帳號的扣分值' });
