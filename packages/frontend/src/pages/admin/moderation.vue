					...
					<MkFolder v-if="enableRecommendedTimeline || collectRecommendedTimelineNotes" style="margin-top: 12px;">
						...
						<div class="_gaps_s">
							...
							<div class="_gaps_s">
								...
								<MkInput v-model.number="recommendedSettings.twoHopBonus" type="number"><template #label>{{ recommendedTimelineAdminText.twoHopBonus }}</template></MkInput>
...
const recommendedSettings = ref({
	...
	twoHopBonus: typeof recommendedRawSettings.twoHopBonus === 'number' ? recommendedRawSettings.twoHopBonus : 3,
...
Object.assign(recommendedTimelineAdminTexts['ja-JP']!, { followingBonus: 'フォロー中アカウント投稿の加点量', twoHopBonus: '二段階フォロー圏アカウント投稿の加点量', reactionAffinityBonus: 'よくリアクションするアカウント投稿の加点量' });
Object.assign(recommendedTimelineAdminTexts['ja-KS']!, { followingBonus: 'フォローしとるアカウント投稿の加点量', twoHopBonus: '二段階フォロー圏アカウント投稿の加点量', reactionAffinityBonus: 'ようリアクションするアカウント投稿の加点量' });
Object.assign(recommendedTimelineAdminTexts['ko-KR']!, { followingBonus: '팔로우 중인 계정 게시물 가점', twoHopBonus: '2단계 팔로우 권역 계정 게시물 가점', reactionAffinityBonus: '자주 반응한 계정 게시물 가점' });
Object.assign(recommendedTimelineAdminTexts['zh-CN']!, { followingBonus: '已关注账号帖文加分值', twoHopBonus: '二度关注范围账号帖文加分值', reactionAffinityBonus: '常互动账号帖文加分值' });
Object.assign(recommendedTimelineAdminTexts['zh-TW']!, { followingBonus: '已追蹤帳號貼文加分值', twoHopBonus: '二度追蹤範圍帳號貼文加分值', reactionAffinityBonus: '常互動帳號貼文加分值' });
