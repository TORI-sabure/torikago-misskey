...
export type AdminDislikedEmojisAddRequest = operations['admin___disliked-emojis___add']['requestBody']['content']['application/json'];
export type AdminDislikedEmojisDeleteRequest = operations['admin___disliked-emojis___delete']['requestBody']['content']['application/json'];
export type AdminDislikedEmojisListRequest = operations['admin___disliked-emojis___list']['requestBody']['content']['application/json'];
export type AdminDislikedEmojisListResponse = operations['admin___disliked-emojis___list']['responses']['200']['content']['application/json'];
...
export type IDislikedEmojisResponse = operations['i___disliked-emojis']['responses']['200']['content']['application/json'];
export type IDislikedEmojisAddRequest = operations['i___disliked-emojis-add']['requestBody']['content']['application/json'];
export type IDislikedEmojisDeleteRequest = operations['i___disliked-emojis-delete']['requestBody']['content']['application/json'];
